...
dictAttribute = {'Vision':        [1.00, 0.98, 0.89, 0.84, 0.75, 0.61],
...
def get_score(vision, hearing, speech, ambulation, dexterity, emotion, cognition, pain):
    ...
    score = dictAttribute['Vision'][vision - 1] * dictAttribute['Hearing'][hearing - 1] * dictAttribute['Ambulation'][ambulation - 1] * dictAttribute[
        'Speech'][speech - 1] * dictAttribute['Dexterity'][dexterity - 1] * dictAttribute['Emotion'][emotion - 1] * dictAttribute['Cognition'][cognition - 1] * dictAttribute[
                'Pain'][pain - 1]

    if vision * hearing * speech * ambulation * dexterity * emotion * cognition * pain:
        score = (score * constant1) - constant2
